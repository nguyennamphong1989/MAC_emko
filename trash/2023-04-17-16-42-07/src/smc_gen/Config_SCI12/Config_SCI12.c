...
void R_Config_SCI12_Create(void)
{
    ...
    SCI12.SMR.BYTE = _00_SCI_CLOCK_PCLK | _00_SCI_MULTI_PROCESSOR_DISABLE | _00_SCI_STOP_1 | _00_SCI_PARITY_DISABLE | 
    ...
    SCI12.SEMR.BYTE = _04_SCI_BIT_MODULATION_ENABLE | _00_SCI_16_BASE_CLOCK | _00_SCI_NOISE_FILTER_DISABLE | 
...
* Description  : This function receives SCI12data
* Arguments    : rx_buf -
...
* Description  : This function transmits SCI12data
* Arguments    : tx_buf -
